 ...
 * explainer plus a demo link to T1. The AestheticBackground gives the
 * page a touch of warmth so it doesn't read as a stark splash screen.
 */
export default function HomePage() {
  return (
    <>
      <AestheticBackground />
      <main className="container relative flex min-h-dvh flex-col items-center justify-center gap-8 py-12 text-center">
